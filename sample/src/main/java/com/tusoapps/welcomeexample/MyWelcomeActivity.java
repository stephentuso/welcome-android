...
public class MyWelcomeActivity extends WelcomeActivity{
    ...
    protected WelcomeScreenConfig configuration() {
        return new WelcomeScreenBuilder(this)
                ...
                .basicPage(R.drawable.periodic_table, "Customizable", "Choose which properties the table shows, sort the element list, how each element's color is calculated, and more.", R.color.orange_background)
                .canSkip(true)
